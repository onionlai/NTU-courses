...
00000000000001de <main>:
{
 ...
 252:	85258593          	addi	a1,a1,-1966 # aa0 <longjmp_1+0x8>
 256:	4509                	li	a0,2
 ...
 288:	83c50513          	addi	a0,a0,-1988 # ac0 <longjmp_1+0x28>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5f4:	4f050513          	addi	a0,a0,1264 # ae0 <digits>
 5f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c0:	424b8b93          	addi	s7,s7,1060 # ae0 <digits>
 ...
 800:	2dc90913          	addi	s2,s2,732 # ad8 <longjmp_1+0x40>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c8:	2347b783          	ld	a5,564(a5) # af8 <freep>
 ...
 8f6:	00e6ea63          	bltu	a3,a4,90a <free+0x50>
{
 ...
 938:	1cf73223          	sd	a5,452(a4) # af8 <freep>
}
 93c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 96a:	19253503          	ld	a0,402(a0) # af8 <freep>
 ...
 992:	16a90913          	addi	s2,s2,362 # af8 <freep>
  if(p == (char*)-1)
 996:	5afd                	li	s5,-1
 998:	a88d                	j	a0a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 99a:	00000797          	auipc	a5,0x0
 99e:	56678793          	addi	a5,a5,1382 # f00 <base>
 9a2:	00000717          	auipc	a4,0x0
 9a6:	14f73b23          	sd	a5,342(a4) # af8 <freep>
 9aa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9cc:	12a73823          	sd	a0,304(a4) # af8 <freep>
      return (void*)(p + 1);
...
0000000000000a26 <setjmp>:
 a26:	e100                	sd	s0,0(a0)
 a28:	e504                	sd	s1,8(a0)
 a2a:	01253823          	sd	s2,16(a0)
 a2e:	01353c23          	sd	s3,24(a0)
 a32:	03453023          	sd	s4,32(a0)
 a36:	03553423          	sd	s5,40(a0)
 a3a:	03653823          	sd	s6,48(a0)
 a3e:	03753c23          	sd	s7,56(a0)
 a42:	05853023          	sd	s8,64(a0)
 a46:	05953423          	sd	s9,72(a0)
 a4a:	05a53823          	sd	s10,80(a0)
 a4e:	05b53c23          	sd	s11,88(a0)
 a52:	06153023          	sd	ra,96(a0)
 a56:	06253423          	sd	sp,104(a0)
 a5a:	4501                	li	a0,0
 a5c:	8082                	ret

0000000000000a5e <longjmp>:
 a5e:	6100                	ld	s0,0(a0)
 a60:	6504                	ld	s1,8(a0)
 a62:	01053903          	ld	s2,16(a0)
 a66:	01853983          	ld	s3,24(a0)
 a6a:	02053a03          	ld	s4,32(a0)
 a6e:	02853a83          	ld	s5,40(a0)
 a72:	03053b03          	ld	s6,48(a0)
 a76:	03853b83          	ld	s7,56(a0)
 a7a:	04053c03          	ld	s8,64(a0)
 a7e:	04853c83          	ld	s9,72(a0)
 a82:	05053d03          	ld	s10,80(a0)
 a86:	05853d83          	ld	s11,88(a0)
 a8a:	06053083          	ld	ra,96(a0)
 a8e:	06853103          	ld	sp,104(a0)
 a92:	c199                	beqz	a1,a98 <longjmp_1>
 a94:	852e                	mv	a0,a1
 a96:	8082                	ret

0000000000000a98 <longjmp_1>:
 a98:	4505                	li	a0,1
 a9a:	8082                	ret
