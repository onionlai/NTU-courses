...
cat(int fd)
{
  ...
  44:	8e058593          	addi	a1,a1,-1824 # 920 <longjmp_1+0x8>
  48:	4509                	li	a0,2
  ...
  72:	8ca58593          	addi	a1,a1,-1846 # 938 <longjmp_1+0x20>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	84e58593          	addi	a1,a1,-1970 # 950 <longjmp_1+0x38>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 474:	50050513          	addi	a0,a0,1280 # 970 <digits>
 478:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 540:	434b8b93          	addi	s7,s7,1076 # 970 <digits>
 ...
 680:	2ec90913          	addi	s2,s2,748 # 968 <longjmp_1+0x50>
        while(*s != 0){
...
free(void *ap)
{
 ...
 748:	2447b783          	ld	a5,580(a5) # 988 <freep>
 ...
 776:	00e6ea63          	bltu	a3,a4,78a <free+0x50>
{
 ...
 7b8:	1cf73a23          	sd	a5,468(a4) # 988 <freep>
}
 7bc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ea:	1a253503          	ld	a0,418(a0) # 988 <freep>
 ...
 812:	17a90913          	addi	s2,s2,378 # 988 <freep>
  if(p == (char*)-1)
 816:	5afd                	li	s5,-1
 818:	a88d                	j	88a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 81a:	00000797          	auipc	a5,0x0
 81e:	37678793          	addi	a5,a5,886 # b90 <base>
 822:	00000717          	auipc	a4,0x0
 826:	16f73323          	sd	a5,358(a4) # 988 <freep>
 82a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 84c:	14a73023          	sd	a0,320(a4) # 988 <freep>
      return (void*)(p + 1);
...
00000000000008a6 <setjmp>:
 8a6:	e100                	sd	s0,0(a0)
 8a8:	e504                	sd	s1,8(a0)
 8aa:	01253823          	sd	s2,16(a0)
 8ae:	01353c23          	sd	s3,24(a0)
 8b2:	03453023          	sd	s4,32(a0)
 8b6:	03553423          	sd	s5,40(a0)
 8ba:	03653823          	sd	s6,48(a0)
 8be:	03753c23          	sd	s7,56(a0)
 8c2:	05853023          	sd	s8,64(a0)
 8c6:	05953423          	sd	s9,72(a0)
 8ca:	05a53823          	sd	s10,80(a0)
 8ce:	05b53c23          	sd	s11,88(a0)
 8d2:	06153023          	sd	ra,96(a0)
 8d6:	06253423          	sd	sp,104(a0)
 8da:	4501                	li	a0,0
 8dc:	8082                	ret

00000000000008de <longjmp>:
 8de:	6100                	ld	s0,0(a0)
 8e0:	6504                	ld	s1,8(a0)
 8e2:	01053903          	ld	s2,16(a0)
 8e6:	01853983          	ld	s3,24(a0)
 8ea:	02053a03          	ld	s4,32(a0)
 8ee:	02853a83          	ld	s5,40(a0)
 8f2:	03053b03          	ld	s6,48(a0)
 8f6:	03853b83          	ld	s7,56(a0)
 8fa:	04053c03          	ld	s8,64(a0)
 8fe:	04853c83          	ld	s9,72(a0)
 902:	05053d03          	ld	s10,80(a0)
 906:	05853d83          	ld	s11,88(a0)
 90a:	06053083          	ld	ra,96(a0)
 90e:	06853103          	ld	sp,104(a0)
 912:	c199                	beqz	a1,918 <longjmp_1>
 914:	852e                	mv	a0,a1
 916:	8082                	ret

0000000000000918 <longjmp_1>:
 918:	4505                	li	a0,1
 91a:	8082                	ret
