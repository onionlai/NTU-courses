...
wc(int fd, char *name)
{
  ...
  3c:	960a0a13          	addi	s4,s4,-1696 # 998 <longjmp_1+0x8>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	8fa50513          	addi	a0,a0,-1798 # 9b0 <longjmp_1+0x20>
  ...
  e8:	8bc50513          	addi	a0,a0,-1860 # 9a0 <longjmp_1+0x10>
...
main(int argc, char *argv[])
{
 ...
 162:	86258593          	addi	a1,a1,-1950 # 9c0 <longjmp_1+0x30>
 166:	4501                	li	a0,0
 ...
 180:	84c50513          	addi	a0,a0,-1972 # 9c8 <longjmp_1+0x38>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ec:	50050513          	addi	a0,a0,1280 # 9e8 <digits>
 4f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b8:	434b8b93          	addi	s7,s7,1076 # 9e8 <digits>
 ...
 6f8:	2ec90913          	addi	s2,s2,748 # 9e0 <longjmp_1+0x50>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c0:	2447b783          	ld	a5,580(a5) # a00 <freep>
 ...
 7ee:	00e6ea63          	bltu	a3,a4,802 <free+0x50>
{
 ...
 830:	1cf73a23          	sd	a5,468(a4) # a00 <freep>
}
 834:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 862:	1a253503          	ld	a0,418(a0) # a00 <freep>
 ...
 88a:	17a90913          	addi	s2,s2,378 # a00 <freep>
  if(p == (char*)-1)
 88e:	5afd                	li	s5,-1
 890:	a88d                	j	902 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 892:	00000797          	auipc	a5,0x0
 896:	37678793          	addi	a5,a5,886 # c08 <base>
 89a:	00000717          	auipc	a4,0x0
 89e:	16f73323          	sd	a5,358(a4) # a00 <freep>
 8a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8c4:	14a73023          	sd	a0,320(a4) # a00 <freep>
      return (void*)(p + 1);
...
000000000000091e <setjmp>:
 91e:	e100                	sd	s0,0(a0)
 920:	e504                	sd	s1,8(a0)
 922:	01253823          	sd	s2,16(a0)
 926:	01353c23          	sd	s3,24(a0)
 92a:	03453023          	sd	s4,32(a0)
 92e:	03553423          	sd	s5,40(a0)
 932:	03653823          	sd	s6,48(a0)
 936:	03753c23          	sd	s7,56(a0)
 93a:	05853023          	sd	s8,64(a0)
 93e:	05953423          	sd	s9,72(a0)
 942:	05a53823          	sd	s10,80(a0)
 946:	05b53c23          	sd	s11,88(a0)
 94a:	06153023          	sd	ra,96(a0)
 94e:	06253423          	sd	sp,104(a0)
 952:	4501                	li	a0,0
 954:	8082                	ret

0000000000000956 <longjmp>:
 956:	6100                	ld	s0,0(a0)
 958:	6504                	ld	s1,8(a0)
 95a:	01053903          	ld	s2,16(a0)
 95e:	01853983          	ld	s3,24(a0)
 962:	02053a03          	ld	s4,32(a0)
 966:	02853a83          	ld	s5,40(a0)
 96a:	03053b03          	ld	s6,48(a0)
 96e:	03853b83          	ld	s7,56(a0)
 972:	04053c03          	ld	s8,64(a0)
 976:	04853c83          	ld	s9,72(a0)
 97a:	05053d03          	ld	s10,80(a0)
 97e:	05853d83          	ld	s11,88(a0)
 982:	06053083          	ld	ra,96(a0)
 986:	06853103          	ld	sp,104(a0)
 98a:	c199                	beqz	a1,990 <longjmp_1>
 98c:	852e                	mv	a0,a1
 98e:	8082                	ret

0000000000000990 <longjmp_1>:
 990:	4505                	li	a0,1
 992:	8082                	ret
