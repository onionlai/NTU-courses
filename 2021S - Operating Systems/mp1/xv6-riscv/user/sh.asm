...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	34858593          	addi	a1,a1,840 # 1358 <longjmp_1+0xa>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	30258593          	addi	a1,a1,770 # 1360 <longjmp_1+0x12>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2d050513          	addi	a0,a0,720 # 1368 <longjmp_1+0x1a>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3a470713          	addi	a4,a4,932 # 1468 <longjmp_1+0x11a>
    ...
    panic("runcmd");
      ...
      e2:	29250513          	addi	a0,a0,658 # 1370 <longjmp_1+0x22>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	27858593          	addi	a1,a1,632 # 1378 <longjmp_1+0x2a>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	23c58593          	addi	a1,a1,572 # 1388 <longjmp_1+0x3a>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1b650513          	addi	a0,a0,438 # 1398 <longjmp_1+0x4a>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	06298993          	addi	s3,s3,98 # 14c0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	ff898993          	addi	s3,s3,-8 # 14c0 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	fe8a8a93          	addi	s5,s5,-24 # 14b8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f8e98993          	addi	s3,s3,-114 # 14c0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e1eb8b93          	addi	s7,s7,-482 # 13c0 <longjmp_1+0x72>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dec50513          	addi	a0,a0,-532 # 13a0 <longjmp_1+0x52>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d2c60613          	addi	a2,a2,-724 # 13c8 <longjmp_1+0x7a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d1cb0b13          	addi	s6,s6,-740 # 13e8 <longjmp_1+0x9a>
  ...
  return ret;
     ...
     70a:	cca50513          	addi	a0,a0,-822 # 13d0 <longjmp_1+0x82>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c7050513          	addi	a0,a0,-912 # 13d8 <longjmp_1+0x8a>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c4e60613          	addi	a2,a2,-946 # 13f0 <longjmp_1+0xa2>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	be6a0a13          	addi	s4,s4,-1050 # 13f8 <longjmp_1+0xaa>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bb860613          	addi	a2,a2,-1096 # 1400 <longjmp_1+0xb2>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b1a60613          	addi	a2,a2,-1254 # 13c8 <longjmp_1+0x7a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b3a60613          	addi	a2,a2,-1222 # 1418 <longjmp_1+0xca>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	ae850513          	addi	a0,a0,-1304 # 1408 <longjmp_1+0xba>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	af050513          	addi	a0,a0,-1296 # 1420 <longjmp_1+0xd2>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b2470713          	addi	a4,a4,-1244 # 1480 <longjmp_1+0x132>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a3060613          	addi	a2,a2,-1488 # 1438 <longjmp_1+0xea>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a0258593          	addi	a1,a1,-1534 # 1440 <longjmp_1+0xf2>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6c4080e7          	jalr	1732(ra) # 110c <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	98050513          	addi	a0,a0,-1664 # 13d0 <longjmp_1+0x82>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9de48493          	addi	s1,s1,-1570 # 1450 <longjmp_1+0x102>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a3848493          	addi	s1,s1,-1480 # 14d0 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a2ba0a13          	addi	s4,s4,-1493 # 14d3 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9a8a8a93          	addi	s5,s5,-1624 # 1458 <longjmp_1+0x10a>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	99e50513          	addi	a0,a0,-1634 # 14d0 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eaa:	5fa50513          	addi	a0,a0,1530 # 14a0 <digits>
     eae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f76:	52eb8b93          	addi	s7,s7,1326 # 14a0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10b6:	3e690913          	addi	s2,s2,998 # 1498 <longjmp_1+0x14a>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    117e:	34e7b783          	ld	a5,846(a5) # 14c8 <freep>
    ...
    11ac:	00e6ea63          	bltu	a3,a4,11c0 <free+0x50>
{
  ...
  freep = p;
    ...
    11ee:	2cf73f23          	sd	a5,734(a4) # 14c8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1220:	2ac53503          	ld	a0,684(a0) # 14c8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1248:	28490913          	addi	s2,s2,644 # 14c8 <freep>
  if(p == (char*)-1)
    124c:	5afd                	li	s5,-1
    124e:	a88d                	j	12c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1250:	00000797          	auipc	a5,0x0
    1254:	2e878793          	addi	a5,a5,744 # 1538 <base>
    1258:	00000717          	auipc	a4,0x0
    125c:	26f73823          	sd	a5,624(a4) # 14c8 <freep>
    ...
    1282:	24a73523          	sd	a0,586(a4) # 14c8 <freep>
      return (void*)(p + 1);
...
00000000000012dc <setjmp>:
    12dc:	e100                	sd	s0,0(a0)
    12de:	e504                	sd	s1,8(a0)
    12e0:	01253823          	sd	s2,16(a0)
    12e4:	01353c23          	sd	s3,24(a0)
    12e8:	03453023          	sd	s4,32(a0)
    12ec:	03553423          	sd	s5,40(a0)
    12f0:	03653823          	sd	s6,48(a0)
    12f4:	03753c23          	sd	s7,56(a0)
    12f8:	05853023          	sd	s8,64(a0)
    12fc:	05953423          	sd	s9,72(a0)
    1300:	05a53823          	sd	s10,80(a0)
    1304:	05b53c23          	sd	s11,88(a0)
    1308:	06153023          	sd	ra,96(a0)
    130c:	06253423          	sd	sp,104(a0)
    1310:	4501                	li	a0,0
    1312:	8082                	ret

0000000000001314 <longjmp>:
    1314:	6100                	ld	s0,0(a0)
    1316:	6504                	ld	s1,8(a0)
    1318:	01053903          	ld	s2,16(a0)
    131c:	01853983          	ld	s3,24(a0)
    1320:	02053a03          	ld	s4,32(a0)
    1324:	02853a83          	ld	s5,40(a0)
    1328:	03053b03          	ld	s6,48(a0)
    132c:	03853b83          	ld	s7,56(a0)
    1330:	04053c03          	ld	s8,64(a0)
    1334:	04853c83          	ld	s9,72(a0)
    1338:	05053d03          	ld	s10,80(a0)
    133c:	05853d83          	ld	s11,88(a0)
    1340:	06053083          	ld	ra,96(a0)
    1344:	06853103          	ld	sp,104(a0)
    1348:	c199                	beqz	a1,134e <longjmp_1>
    134a:	852e                	mv	a0,a1
    134c:	8082                	ret

000000000000134e <longjmp_1>:
    134e:	4505                	li	a0,1
    1350:	8082                	ret
