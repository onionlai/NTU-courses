...
main(int argc, char *argv[])
{
  ...
  14:	85058593          	addi	a1,a1,-1968 # 860 <longjmp_1+0x6>
  18:	4509                	li	a0,2
  ...
  50:	82c58593          	addi	a1,a1,-2004 # 878 <longjmp_1+0x1e>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b6:	4e650513          	addi	a0,a0,1254 # 898 <digits>
 3ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c2:	2d290913          	addi	s2,s2,722 # 890 <longjmp_1+0x36>
        while(*s != 0){
 ...
 6b8:	00e6ea63          	bltu	a3,a4,6cc <free+0x50>
{
 ...
 6fa:	1af73d23          	sd	a5,442(a4) # 8b0 <freep>
}
 6fe:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72c:	18853503          	ld	a0,392(a0) # 8b0 <freep>
 ...
 754:	16090913          	addi	s2,s2,352 # 8b0 <freep>
  if(p == (char*)-1)
 758:	5afd                	li	s5,-1
 75a:	a88d                	j	7cc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75c:	00000797          	auipc	a5,0x0
 760:	15c78793          	addi	a5,a5,348 # 8b8 <base>
 ...
 78e:	12a73323          	sd	a0,294(a4) # 8b0 <freep>
      return (void*)(p + 1);
...
00000000000007e8 <setjmp>:
 7e8:	e100                	sd	s0,0(a0)
 7ea:	e504                	sd	s1,8(a0)
 7ec:	01253823          	sd	s2,16(a0)
 7f0:	01353c23          	sd	s3,24(a0)
 7f4:	03453023          	sd	s4,32(a0)
 7f8:	03553423          	sd	s5,40(a0)
 7fc:	03653823          	sd	s6,48(a0)
 800:	03753c23          	sd	s7,56(a0)
 804:	05853023          	sd	s8,64(a0)
 808:	05953423          	sd	s9,72(a0)
 80c:	05a53823          	sd	s10,80(a0)
 810:	05b53c23          	sd	s11,88(a0)
 814:	06153023          	sd	ra,96(a0)
 818:	06253423          	sd	sp,104(a0)
 81c:	4501                	li	a0,0
 81e:	8082                	ret

0000000000000820 <longjmp>:
 820:	6100                	ld	s0,0(a0)
 822:	6504                	ld	s1,8(a0)
 824:	01053903          	ld	s2,16(a0)
 828:	01853983          	ld	s3,24(a0)
 82c:	02053a03          	ld	s4,32(a0)
 830:	02853a83          	ld	s5,40(a0)
 834:	03053b03          	ld	s6,48(a0)
 838:	03853b83          	ld	s7,56(a0)
 83c:	04053c03          	ld	s8,64(a0)
 840:	04853c83          	ld	s9,72(a0)
 844:	05053d03          	ld	s10,80(a0)
 848:	05853d83          	ld	s11,88(a0)
 84c:	06053083          	ld	ra,96(a0)
 850:	06853103          	ld	sp,104(a0)
 854:	c199                	beqz	a1,85a <longjmp_1>
 856:	852e                	mv	a0,a1
 858:	8082                	ret

000000000000085a <longjmp_1>:
 85a:	4505                	li	a0,1
 85c:	8082                	ret
