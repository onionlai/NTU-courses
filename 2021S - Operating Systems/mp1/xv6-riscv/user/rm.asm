...
main(int argc, char *argv[])
{
  ...
  42:	83a58593          	addi	a1,a1,-1990 # 878 <longjmp_1+0x6>
  46:	4509                	li	a0,2
  ...
  60:	83458593          	addi	a1,a1,-1996 # 890 <longjmp_1+0x1e>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ce:	4ee50513          	addi	a0,a0,1262 # 8b8 <digits>
 3d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	422b8b93          	addi	s7,s7,1058 # 8b8 <digits>
 ...
 5da:	2da90913          	addi	s2,s2,730 # 8b0 <longjmp_1+0x3e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 778:	16478793          	addi	a5,a5,356 # 8d8 <base>
