...
main(int argc, char *argv[])
{
  ...
  // printf("\nthe address of p in heap: %p\n", p);
  // printf("\n\nthe address of p1: %p", &p1);
  // printf("\nthe address of p1 in heap: %p\n", p1);
  // printf("\n\nthe address of p2: %p", &p2);
  // printf("\nthe address of p2 in heap: %p\n", p2);
  // printf("\n\nthe address of p3: %p", &p3);
  // printf("\nthe address of p3 in heap: %p\n", p3);
  // printf("\n\nthe address of p4: %p", &p4);
  // printf("\nthe address of p4 in heap: %p\n", p4);
  // printf("\n\nthe address of p5: %p", &p5);
  // printf("\nthe address of p5 in heap: %p\n", p5);
