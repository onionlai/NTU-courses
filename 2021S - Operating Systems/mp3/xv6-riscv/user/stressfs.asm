...
main(int argc, char *argv[])
{
  ...
  1a:	94278793          	addi	a5,a5,-1726 # 958 <longjmp_1+0x3a>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8fc50513          	addi	a0,a0,-1796 # 928 <longjmp_1+0xa>
  ...
  6c:	8d850513          	addi	a0,a0,-1832 # 940 <longjmp_1+0x22>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	89a50513          	addi	a0,a0,-1894 # 950 <longjmp_1+0x32>
...
000000000000042a <cancelthrdstop>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	4fa50513          	addi	a0,a0,1274 # 970 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 546:	42eb8b93          	addi	s7,s7,1070 # 970 <digits>
 ...
 686:	2e690913          	addi	s2,s2,742 # 968 <longjmp_1+0x4a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74e:	23e7b783          	ld	a5,574(a5) # 988 <freep>
 ...
 77c:	00e6ea63          	bltu	a3,a4,790 <free+0x50>
{
 ...
 7be:	1cf73723          	sd	a5,462(a4) # 988 <freep>
}
 7c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f0:	19c53503          	ld	a0,412(a0) # 988 <freep>
 ...
 818:	17490913          	addi	s2,s2,372 # 988 <freep>
  if(p == (char*)-1)
 81c:	5afd                	li	s5,-1
 81e:	a88d                	j	890 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 820:	00000797          	auipc	a5,0x0
 824:	17078793          	addi	a5,a5,368 # 990 <base>
 ...
 852:	12a73d23          	sd	a0,314(a4) # 988 <freep>
      return (void*)(p + 1);
...
00000000000008ac <setjmp>:
 8ac:	e100                	sd	s0,0(a0)
 8ae:	e504                	sd	s1,8(a0)
 8b0:	01253823          	sd	s2,16(a0)
 8b4:	01353c23          	sd	s3,24(a0)
 8b8:	03453023          	sd	s4,32(a0)
 8bc:	03553423          	sd	s5,40(a0)
 8c0:	03653823          	sd	s6,48(a0)
 8c4:	03753c23          	sd	s7,56(a0)
 8c8:	05853023          	sd	s8,64(a0)
 8cc:	05953423          	sd	s9,72(a0)
 8d0:	05a53823          	sd	s10,80(a0)
 8d4:	05b53c23          	sd	s11,88(a0)
 8d8:	06153023          	sd	ra,96(a0)
 8dc:	06253423          	sd	sp,104(a0)
 8e0:	4501                	li	a0,0
 8e2:	8082                	ret

00000000000008e4 <longjmp>:
 8e4:	6100                	ld	s0,0(a0)
 8e6:	6504                	ld	s1,8(a0)
 8e8:	01053903          	ld	s2,16(a0)
 8ec:	01853983          	ld	s3,24(a0)
 8f0:	02053a03          	ld	s4,32(a0)
 8f4:	02853a83          	ld	s5,40(a0)
 8f8:	03053b03          	ld	s6,48(a0)
 8fc:	03853b83          	ld	s7,56(a0)
 900:	04053c03          	ld	s8,64(a0)
 904:	04853c83          	ld	s9,72(a0)
 908:	05053d03          	ld	s10,80(a0)
 90c:	05853d83          	ld	s11,88(a0)
 910:	06053083          	ld	ra,96(a0)
 914:	06853103          	ld	sp,104(a0)
 918:	c199                	beqz	a1,91e <longjmp_1>
 91a:	852e                	mv	a0,a1
 91c:	8082                	ret

000000000000091e <longjmp_1>:
 91e:	4505                	li	a0,1
 920:	8082                	ret
