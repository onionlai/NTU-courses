...
main(int argc, char *argv[])
{
  ...
  14:	86858593          	addi	a1,a1,-1944 # 878 <longjmp_1+0x6>
  18:	4509                	li	a0,2
  ...
  50:	84458593          	addi	a1,a1,-1980 # 890 <longjmp_1+0x1e>
  54:	4509                	li	a0,2
...
000000000000037e <cancelthrdstop>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ce:	4e650513          	addi	a0,a0,1254 # 8b0 <digits>
 3d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	41ab8b93          	addi	s7,s7,1050 # 8b0 <digits>
 ...
 5da:	2d290913          	addi	s2,s2,722 # 8a8 <longjmp_1+0x36>
        while(*s != 0){
 ...
 6d0:	00e6ea63          	bltu	a3,a4,6e4 <free+0x50>
{
 ...
 712:	1af73d23          	sd	a5,442(a4) # 8c8 <freep>
}
 716:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76c:	16090913          	addi	s2,s2,352 # 8c8 <freep>
  if(p == (char*)-1)
 770:	5afd                	li	s5,-1
 772:	a88d                	j	7e4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 774:	00000797          	auipc	a5,0x0
 778:	15c78793          	addi	a5,a5,348 # 8d0 <base>
 77c:	00000717          	auipc	a4,0x0
 780:	14f73623          	sd	a5,332(a4) # 8c8 <freep>
 784:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a6:	12a73323          	sd	a0,294(a4) # 8c8 <freep>
      return (void*)(p + 1);
...
0000000000000800 <setjmp>:
 800:	e100                	sd	s0,0(a0)
 802:	e504                	sd	s1,8(a0)
 804:	01253823          	sd	s2,16(a0)
 808:	01353c23          	sd	s3,24(a0)
 80c:	03453023          	sd	s4,32(a0)
 810:	03553423          	sd	s5,40(a0)
 814:	03653823          	sd	s6,48(a0)
 818:	03753c23          	sd	s7,56(a0)
 81c:	05853023          	sd	s8,64(a0)
 820:	05953423          	sd	s9,72(a0)
 824:	05a53823          	sd	s10,80(a0)
 828:	05b53c23          	sd	s11,88(a0)
 82c:	06153023          	sd	ra,96(a0)
 830:	06253423          	sd	sp,104(a0)
 834:	4501                	li	a0,0
 836:	8082                	ret

0000000000000838 <longjmp>:
 838:	6100                	ld	s0,0(a0)
 83a:	6504                	ld	s1,8(a0)
 83c:	01053903          	ld	s2,16(a0)
 840:	01853983          	ld	s3,24(a0)
 844:	02053a03          	ld	s4,32(a0)
 848:	02853a83          	ld	s5,40(a0)
 84c:	03053b03          	ld	s6,48(a0)
 850:	03853b83          	ld	s7,56(a0)
 854:	04053c03          	ld	s8,64(a0)
 858:	04853c83          	ld	s9,72(a0)
 85c:	05053d03          	ld	s10,80(a0)
 860:	05853d83          	ld	s11,88(a0)
 864:	06053083          	ld	ra,96(a0)
 868:	06853103          	ld	sp,104(a0)
 86c:	c199                	beqz	a1,872 <longjmp_1>
 86e:	852e                	mv	a0,a1
 870:	8082                	ret

0000000000000872 <longjmp_1>:
 872:	4505                	li	a0,1
 874:	8082                	ret
