...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	36058593          	addi	a1,a1,864 # 1370 <longjmp_1+0xa>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	31a58593          	addi	a1,a1,794 # 1378 <longjmp_1+0x12>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2e850513          	addi	a0,a0,744 # 1380 <longjmp_1+0x1a>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3bc70713          	addi	a4,a4,956 # 1480 <longjmp_1+0x11a>
    ...
    panic("runcmd");
      ...
      e2:	2aa50513          	addi	a0,a0,682 # 1388 <longjmp_1+0x22>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	29058593          	addi	a1,a1,656 # 1390 <longjmp_1+0x2a>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	25458593          	addi	a1,a1,596 # 13a0 <longjmp_1+0x3a>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1ce50513          	addi	a0,a0,462 # 13b0 <longjmp_1+0x4a>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e36b8b93          	addi	s7,s7,-458 # 13d8 <longjmp_1+0x72>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e0450513          	addi	a0,a0,-508 # 13b8 <longjmp_1+0x52>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d4460613          	addi	a2,a2,-700 # 13e0 <longjmp_1+0x7a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d34b0b13          	addi	s6,s6,-716 # 1400 <longjmp_1+0x9a>
  ...
  return ret;
     ...
     70a:	ce250513          	addi	a0,a0,-798 # 13e8 <longjmp_1+0x82>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c8850513          	addi	a0,a0,-888 # 13f0 <longjmp_1+0x8a>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c6660613          	addi	a2,a2,-922 # 1408 <longjmp_1+0xa2>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bfea0a13          	addi	s4,s4,-1026 # 1410 <longjmp_1+0xaa>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bd060613          	addi	a2,a2,-1072 # 1418 <longjmp_1+0xb2>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b3260613          	addi	a2,a2,-1230 # 13e0 <longjmp_1+0x7a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b5260613          	addi	a2,a2,-1198 # 1430 <longjmp_1+0xca>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	b0050513          	addi	a0,a0,-1280 # 1420 <longjmp_1+0xba>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	b0850513          	addi	a0,a0,-1272 # 1438 <longjmp_1+0xd2>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b3c70713          	addi	a4,a4,-1220 # 1498 <longjmp_1+0x132>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a4860613          	addi	a2,a2,-1464 # 1450 <longjmp_1+0xea>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a1a58593          	addi	a1,a1,-1510 # 1458 <longjmp_1+0xf2>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6dc080e7          	jalr	1756(ra) # 1124 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	99850513          	addi	a0,a0,-1640 # 13e8 <longjmp_1+0x82>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9f648493          	addi	s1,s1,-1546 # 1468 <longjmp_1+0x102>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab4:	9c0a8a93          	addi	s5,s5,-1600 # 1470 <longjmp_1+0x10a>
...
0000000000000e72 <cancelthrdstop>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec2:	5fa50513          	addi	a0,a0,1530 # 14b8 <digits>
     ec6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f8e:	52eb8b93          	addi	s7,s7,1326 # 14b8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10ce:	3e690913          	addi	s2,s2,998 # 14b0 <longjmp_1+0x14a>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1196:	34e7b783          	ld	a5,846(a5) # 14e0 <freep>
    ...
    11c4:	00e6ea63          	bltu	a3,a4,11d8 <free+0x50>
{
  ...
  freep = p;
    ...
    1206:	2cf73f23          	sd	a5,734(a4) # 14e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1238:	2ac53503          	ld	a0,684(a0) # 14e0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1260:	28490913          	addi	s2,s2,644 # 14e0 <freep>
  if(p == (char*)-1)
    1264:	5afd                	li	s5,-1
    1266:	a88d                	j	12d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1268:	00000797          	auipc	a5,0x0
    126c:	2e878793          	addi	a5,a5,744 # 1550 <base>
    1270:	00000717          	auipc	a4,0x0
    1274:	26f73823          	sd	a5,624(a4) # 14e0 <freep>
    ...
    129a:	24a73523          	sd	a0,586(a4) # 14e0 <freep>
      return (void*)(p + 1);
...
00000000000012f4 <setjmp>:
    12f4:	e100                	sd	s0,0(a0)
    12f6:	e504                	sd	s1,8(a0)
    12f8:	01253823          	sd	s2,16(a0)
    12fc:	01353c23          	sd	s3,24(a0)
    1300:	03453023          	sd	s4,32(a0)
    1304:	03553423          	sd	s5,40(a0)
    1308:	03653823          	sd	s6,48(a0)
    130c:	03753c23          	sd	s7,56(a0)
    1310:	05853023          	sd	s8,64(a0)
    1314:	05953423          	sd	s9,72(a0)
    1318:	05a53823          	sd	s10,80(a0)
    131c:	05b53c23          	sd	s11,88(a0)
    1320:	06153023          	sd	ra,96(a0)
    1324:	06253423          	sd	sp,104(a0)
    1328:	4501                	li	a0,0
    132a:	8082                	ret

000000000000132c <longjmp>:
    132c:	6100                	ld	s0,0(a0)
    132e:	6504                	ld	s1,8(a0)
    1330:	01053903          	ld	s2,16(a0)
    1334:	01853983          	ld	s3,24(a0)
    1338:	02053a03          	ld	s4,32(a0)
    133c:	02853a83          	ld	s5,40(a0)
    1340:	03053b03          	ld	s6,48(a0)
    1344:	03853b83          	ld	s7,56(a0)
    1348:	04053c03          	ld	s8,64(a0)
    134c:	04853c83          	ld	s9,72(a0)
    1350:	05053d03          	ld	s10,80(a0)
    1354:	05853d83          	ld	s11,88(a0)
    1358:	06053083          	ld	ra,96(a0)
    135c:	06853103          	ld	sp,104(a0)
    1360:	c199                	beqz	a1,1366 <longjmp_1>
    1362:	852e                	mv	a0,a1
    1364:	8082                	ret

0000000000001366 <longjmp_1>:
    1366:	4505                	li	a0,1
    1368:	8082                	ret
