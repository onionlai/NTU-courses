...
main(int argc, char *argv[])
{
  ...
  2e:	876a0a13          	addi	s4,s4,-1930 # 8a0 <longjmp_1+0xa>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	84058593          	addi	a1,a1,-1984 # 8a8 <longjmp_1+0x12>
  70:	4505                	li	a0,1
...
00000000000003a2 <cancelthrdstop>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	3feb8b93          	addi	s7,s7,1022 # 8b8 <digits>
 ...
 5fe:	2b690913          	addi	s2,s2,694 # 8b0 <longjmp_1+0x1a>
        while(*s != 0){
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x50>
{
 ...
 736:	18f73f23          	sd	a5,414(a4) # 8d0 <freep>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 768:	16c53503          	ld	a0,364(a0) # 8d0 <freep>
 ...
 790:	14490913          	addi	s2,s2,324 # 8d0 <freep>
  if(p == (char*)-1)
 794:	5afd                	li	s5,-1
 796:	a88d                	j	808 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 798:	00000797          	auipc	a5,0x0
 79c:	14078793          	addi	a5,a5,320 # 8d8 <base>
 7a0:	00000717          	auipc	a4,0x0
 7a4:	12f73823          	sd	a5,304(a4) # 8d0 <freep>
 7a8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ca:	10a73523          	sd	a0,266(a4) # 8d0 <freep>
      return (void*)(p + 1);
...
0000000000000824 <setjmp>:
 824:	e100                	sd	s0,0(a0)
 826:	e504                	sd	s1,8(a0)
 828:	01253823          	sd	s2,16(a0)
 82c:	01353c23          	sd	s3,24(a0)
 830:	03453023          	sd	s4,32(a0)
 834:	03553423          	sd	s5,40(a0)
 838:	03653823          	sd	s6,48(a0)
 83c:	03753c23          	sd	s7,56(a0)
 840:	05853023          	sd	s8,64(a0)
 844:	05953423          	sd	s9,72(a0)
 848:	05a53823          	sd	s10,80(a0)
 84c:	05b53c23          	sd	s11,88(a0)
 850:	06153023          	sd	ra,96(a0)
 854:	06253423          	sd	sp,104(a0)
 858:	4501                	li	a0,0
 85a:	8082                	ret

000000000000085c <longjmp>:
 85c:	6100                	ld	s0,0(a0)
 85e:	6504                	ld	s1,8(a0)
 860:	01053903          	ld	s2,16(a0)
 864:	01853983          	ld	s3,24(a0)
 868:	02053a03          	ld	s4,32(a0)
 86c:	02853a83          	ld	s5,40(a0)
 870:	03053b03          	ld	s6,48(a0)
 874:	03853b83          	ld	s7,56(a0)
 878:	04053c03          	ld	s8,64(a0)
 87c:	04853c83          	ld	s9,72(a0)
 880:	05053d03          	ld	s10,80(a0)
 884:	05853d83          	ld	s11,88(a0)
 888:	06053083          	ld	ra,96(a0)
 88c:	06853103          	ld	sp,104(a0)
 890:	c199                	beqz	a1,896 <longjmp_1>
 892:	852e                	mv	a0,a1
 894:	8082                	ret

0000000000000896 <longjmp_1>:
 896:	4505                	li	a0,1
 898:	8082                	ret
