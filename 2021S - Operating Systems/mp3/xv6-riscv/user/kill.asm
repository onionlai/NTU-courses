...
main(int argc, char **argv)
{
  ...
  4c:	83858593          	addi	a1,a1,-1992 # 880 <longjmp_1+0xa>
  50:	4509                	li	a0,2
...
0000000000000382 <cancelthrdstop>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	4d250513          	addi	a0,a0,1234 # 8a0 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49e:	406b8b93          	addi	s7,s7,1030 # 8a0 <digits>
 ...
 5de:	2be90913          	addi	s2,s2,702 # 898 <longjmp_1+0x22>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a6:	2167b783          	ld	a5,534(a5) # 8b8 <freep>
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x50>
{
 ...
 716:	1af73323          	sd	a5,422(a4) # 8b8 <freep>
}
 71a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 748:	17453503          	ld	a0,372(a0) # 8b8 <freep>
 ...
 770:	14c90913          	addi	s2,s2,332 # 8b8 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 776:	a88d                	j	7e8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 778:	00000797          	auipc	a5,0x0
 77c:	14878793          	addi	a5,a5,328 # 8c0 <base>
 780:	00000717          	auipc	a4,0x0
 784:	12f73c23          	sd	a5,312(a4) # 8b8 <freep>
 788:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
...
0000000000000804 <setjmp>:
 804:	e100                	sd	s0,0(a0)
 806:	e504                	sd	s1,8(a0)
 808:	01253823          	sd	s2,16(a0)
 80c:	01353c23          	sd	s3,24(a0)
 810:	03453023          	sd	s4,32(a0)
 814:	03553423          	sd	s5,40(a0)
 818:	03653823          	sd	s6,48(a0)
 81c:	03753c23          	sd	s7,56(a0)
 820:	05853023          	sd	s8,64(a0)
 824:	05953423          	sd	s9,72(a0)
 828:	05a53823          	sd	s10,80(a0)
 82c:	05b53c23          	sd	s11,88(a0)
 830:	06153023          	sd	ra,96(a0)
 834:	06253423          	sd	sp,104(a0)
 838:	4501                	li	a0,0
 83a:	8082                	ret

000000000000083c <longjmp>:
 83c:	6100                	ld	s0,0(a0)
 83e:	6504                	ld	s1,8(a0)
 840:	01053903          	ld	s2,16(a0)
 844:	01853983          	ld	s3,24(a0)
 848:	02053a03          	ld	s4,32(a0)
 84c:	02853a83          	ld	s5,40(a0)
 850:	03053b03          	ld	s6,48(a0)
 854:	03853b83          	ld	s7,56(a0)
 858:	04053c03          	ld	s8,64(a0)
 85c:	04853c83          	ld	s9,72(a0)
 860:	05053d03          	ld	s10,80(a0)
 864:	05853d83          	ld	s11,88(a0)
 868:	06053083          	ld	ra,96(a0)
 86c:	06853103          	ld	sp,104(a0)
 870:	c199                	beqz	a1,876 <longjmp_1>
 872:	852e                	mv	a0,a1
 874:	8082                	ret

0000000000000876 <longjmp_1>:
 876:	4505                	li	a0,1
 878:	8082                	ret
