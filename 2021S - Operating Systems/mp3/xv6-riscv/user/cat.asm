...
cat(int fd)
{
  ...
  44:	8f858593          	addi	a1,a1,-1800 # 938 <longjmp_1+0x8>
  48:	4509                	li	a0,2
  ...
  72:	8e258593          	addi	a1,a1,-1822 # 950 <longjmp_1+0x20>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	86658593          	addi	a1,a1,-1946 # 968 <longjmp_1+0x38>
 10a:	4509                	li	a0,2
...
000000000000043c <cancelthrdstop>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 558:	434b8b93          	addi	s7,s7,1076 # 988 <digits>
 ...
 698:	2ec90913          	addi	s2,s2,748 # 980 <longjmp_1+0x50>
        while(*s != 0){
...
free(void *ap)
{
 ...
 760:	2447b783          	ld	a5,580(a5) # 9a0 <freep>
 ...
 78e:	00e6ea63          	bltu	a3,a4,7a2 <free+0x50>
{
 ...
 7d0:	1cf73a23          	sd	a5,468(a4) # 9a0 <freep>
}
 7d4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 82a:	17a90913          	addi	s2,s2,378 # 9a0 <freep>
  if(p == (char*)-1)
 82e:	5afd                	li	s5,-1
 830:	a88d                	j	8a2 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 832:	00000797          	auipc	a5,0x0
 836:	37678793          	addi	a5,a5,886 # ba8 <base>
 83a:	00000717          	auipc	a4,0x0
 83e:	16f73323          	sd	a5,358(a4) # 9a0 <freep>
 842:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 864:	14a73023          	sd	a0,320(a4) # 9a0 <freep>
      return (void*)(p + 1);
...
00000000000008be <setjmp>:
 8be:	e100                	sd	s0,0(a0)
 8c0:	e504                	sd	s1,8(a0)
 8c2:	01253823          	sd	s2,16(a0)
 8c6:	01353c23          	sd	s3,24(a0)
 8ca:	03453023          	sd	s4,32(a0)
 8ce:	03553423          	sd	s5,40(a0)
 8d2:	03653823          	sd	s6,48(a0)
 8d6:	03753c23          	sd	s7,56(a0)
 8da:	05853023          	sd	s8,64(a0)
 8de:	05953423          	sd	s9,72(a0)
 8e2:	05a53823          	sd	s10,80(a0)
 8e6:	05b53c23          	sd	s11,88(a0)
 8ea:	06153023          	sd	ra,96(a0)
 8ee:	06253423          	sd	sp,104(a0)
 8f2:	4501                	li	a0,0
 8f4:	8082                	ret

00000000000008f6 <longjmp>:
 8f6:	6100                	ld	s0,0(a0)
 8f8:	6504                	ld	s1,8(a0)
 8fa:	01053903          	ld	s2,16(a0)
 8fe:	01853983          	ld	s3,24(a0)
 902:	02053a03          	ld	s4,32(a0)
 906:	02853a83          	ld	s5,40(a0)
 90a:	03053b03          	ld	s6,48(a0)
 90e:	03853b83          	ld	s7,56(a0)
 912:	04053c03          	ld	s8,64(a0)
 916:	04853c83          	ld	s9,72(a0)
 91a:	05053d03          	ld	s10,80(a0)
 91e:	05853d83          	ld	s11,88(a0)
 922:	06053083          	ld	ra,96(a0)
 926:	06853103          	ld	sp,104(a0)
 92a:	c199                	beqz	a1,930 <longjmp_1>
 92c:	852e                	mv	a0,a1
 92e:	8082                	ret

0000000000000930 <longjmp_1>:
 930:	4505                	li	a0,1
 932:	8082                	ret
